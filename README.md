...
Estos archivos no deberían subirse al repositorio:
...
El archivo .env puede contener credenciales y API keys privadas.

📤 Archivos que sí deben subirse

El repositorio debería incluir, entre otros:
...
Finalmente, abre un Pull Request en GitHub.

📤 Subir el proyecto a GitHub

Desde la raíz del proyecto:

cd C:\Users\amaya\Desktop\oracle-quiz-solver
...
Comprueba los archivos que serán incluidos:

git add .
git status


Antes del commit, verifica especialmente que .env y otros archivos privados no aparezcan en la lista.

Realiza el commit inicial:

git commit -m "Initial commit: Oracle Quiz Solver"


Añade el repositorio remoto:

git remote add origin https://github.com/tu-usuario/oracle-quiz-solver.git


Establece main como rama principal:
...
Esta herramienta se proporciona con fines educativos y personales.

El usuario es responsable de:

Cumplir los términos de servicio de Oracle Academy.
Cumplir las políticas académicas de su institución.
No utilizar la herramienta para actividades académicas deshonestas.
Verificar que el uso de la herramienta sea compatible con las reglas del curso o plataforma.
Proteger sus API keys y demás credenciales.

Los autores no se hacen responsables del uso indebido de este proyecto.
...
Reemplaza Tu Nombre y tu-usuario con tus datos antes de publicar el repositorio.

🙏 Agradecimientos

Este proyecto utiliza y/o se inspira en las siguientes tecnologías:

Google Gemini — servicios de IA.
